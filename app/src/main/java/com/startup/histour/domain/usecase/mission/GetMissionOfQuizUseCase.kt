...
@ViewModelScoped
class GetMissionOfQuizUseCase @Inject constructor(
...
) : BaseUseCase<ResponseQuizDto, String>(
    coroutineScope = coroutineScope,
    preExecutionContext = preExecutionContext,
    postExecutionContext = postExecutionContext
) {
    override suspend fun buildUseCase(params: String): Flow<ResponseQuizDto> = missionRepository.getQuiz(params)
}